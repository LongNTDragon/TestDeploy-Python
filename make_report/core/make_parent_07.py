...
@exception_handler
def make_parent_07(base_url, options, path):
    data = {
        "header": "parent_07",
        ...
        "recommended_activities":{
            "parent":"아이는 자신만의 방법으로 정보를 기억하고 명확하게 상상한 후 주어진 작업을 잘 수행하고 있습니다. 부모님께서는 자녀의 작업기억력 향상을 위해 다양한 방법으로 정보를 기억하고 활용할 수 있는 환경을 제공해야 합니다. ＇연상 기억법＇을 활용해 순서대로 외워야 하는 정보를 기억하는 방법을 알려주세요. 예를 들어, 등굣길에서 보이는 익숙한 장소들과 기억해야 할 정보를 연결해보는 방법입니다. 예를 들어, 집 앞 벤치에서 누워있는 쥐를 상상하고, 놀이터에서 놀고 있는 소를 연상하면서 12간지를 기억할 수 있습니다. 이런 방법은 정보의 기억과 활용을 증진해줍니다. 익숙해지면 다음으로 외워야 할 정보의 양을 점차 늘려보세요. 자녀가 성공적으로 기억하면 충분한 칭찬과 격려를 통해 긍정적인 정서와 지속적인 동기부여를 제공하는 것이 좋습니다.",
            "alone":"자녀는 자신이 좋아하는 활동을 하면서 작업기억력을 향상할 수 있습니다. 부모님은 ＇취미 찾기＇를 통해 다양한 흥미 요소를 제시하고 아이의 동기를 높일 수 있습니다. 아이의 관심이 가는 스포츠, 새로운 보드게임의 규칙, 또는 좋아하는 음식을 만드는 방법을 찾도록 유도해주세요. 그리고 아이에게 학습한 내용을 친구들이나 부모님에게 설명하고, 실제로 스포츠, 보드게임 또는 요리를 시작하도록 도와주세요. 설명 과정에서 어려움을 겪을 때는 충분한 시간을 주거나, 단어 힌트 혹은 간단한 질문을 통해 기억을 돕는 것이 좋습니다. 이러한 과정에서 아이는 부모가 가르쳐준 기억 방법을 연습하거나 자신만의 창의적인 방법으로 기억을 되살릴 수 있게 됩니다. 작은 성취와 즐거운 경험을 지속하면서 작업기억력은 향상될 것입니다."
        }
    }
